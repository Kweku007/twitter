...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    ...
    func likeTweet(tweetId:Int, success: @escaping () -> (),
                   failure: @escaping (Error) -> ()){
    ...
    func unlikeTweet(tweetId:Int, success: @escaping () -> (),
                   failure: @escaping (Error) -> ()){
    ...
    func retweet(tweetId:Int, success: @escaping () -> (),
                   failure: @escaping (Error) -> ()){
    ...
    func unretweet(tweetId:Int, success: @escaping () -> (),
                   failure: @escaping (Error) -> ()){
